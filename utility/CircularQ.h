...
public:
	...
	virtual uint16_t size(void) {return 0;};
	virtual uint16_t used(void) {return 0;};
	virtual uint16_t free(void) {return 0;};
	virtual bool valueAvailable(uint16_t = 1) {return false;};
	virtual bool spaceAvailable(uint16_t = 1) {return false;};
	virtual TYPE get(void) {return TYPE(0);};
	virtual bool put(TYPE) {return false;};
	...
	virtual void drop(uint16_t ) {};
	virtual TYPE* getLinearWriteBuffer(void) {return 0;};
	virtual uint16_t getLinearWriteBufferSize(void) {return 0;};
	virtual void append(uint16_t ) {};
	virtual void setHead(uint16_t ) {};
	virtual void setNextQ( CircularQBase<TYPE>& ) {};
	virtual void setPreviousQ( CircularQBase<TYPE>& ) {};
	virtual void setNextQ( CircularQBase<TYPE>* ) {};
	virtual void setPreviousQ( CircularQBase<TYPE>* ) {};
...
public:
	 ...
	 */
	bool valueAvailable(uint16_t n = 1) {
		return used() >= n;
	}
	 ...
	 */
	bool spaceAvailable(uint16_t n = 1) {
		return free() >= n;
	}
